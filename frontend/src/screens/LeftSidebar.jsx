...
function LeftSidebar() {
    ...
    return (
        <>
            <div className=' max-w-3/12 h-screen mt-5 pl-14 py-2 sticky top-0'>
                <div className='max-w-full h-14 pl-1'>
                ...
                <div className='max-w-full min-h-14 h-14'>
                ...
                <div className='max-w-full xl:min-h-14 h-14 -ml-1'>
                ...
                <div className='max-w-full h-14 -ml-2'>
                    <div className='flex  cursor-pointer duration-200  hover:bg-slate-200 w-fit rounded-full px-4 py-2'>
                ...
                <div className='max-w-full h-14 -ml-1 '>
                    <div className='flex  cursor-pointer duration-200  hover:bg-slate-200 w-fit rounded-full px-3 py-2'>
                ...
                <div className='max-w-full h-14 pt-2'>
                    <button onClick={() => document.getElementById('my_modal_3').showModal()} className=' bg-blue-500 hover:bg-blue-600 duration-200 text-white xl:px-24 px-16 py-3 rounded-3xl text-md font-semibold'>
                        Post
                    </button>
                    <CreatePostModal />
                    {
